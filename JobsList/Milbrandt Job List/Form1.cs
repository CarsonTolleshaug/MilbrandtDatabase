    ...
    public partial class Form1 : Form
    {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            if (form.newJob != null)
            {
                ...
                {
                    MessageBox.Show("Another user has already edited or removed this job.");
                    LoadData();
                    UpdateDisplay();
                    return;
                }
        ...
        private void SendEmail(Job j_changed)
        {
            try
            {
                ...
                //message prarams:
                if (DEBUG)
                    message.To.Add("carson.tolleshaug@wsu.edu");
                else
                ...
                smtp.Port = 587;
                smtp.Credentials = new System.Net.NetworkCredential("milbrandtjoblist", "Sy4&64Bc");
                smtp.EnableSsl = true;
                smtp.Send(message);
            }
            catch (Exception ex)
